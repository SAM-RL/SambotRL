...
#include <sambot_base/ParametersConfig.h>
...
namespace sambot_base
{
	...
	void updateParameters(double f, double p, double i, double d);
        ...
        void updateDynamicReconfig(sambot_base::ParametersConfig config);

        /**
         * \brief Update the PID parameters from dynamics reconfigure
         */
        void dynamicReconfigCallback(sambot_base::ParametersConfig &config, uint32_t /*level*/);
    ...
    private:
        ...
        typedef dynamic_reconfigure::Server<sambot_base::ParametersConfig> DynamicReconfigServer;
