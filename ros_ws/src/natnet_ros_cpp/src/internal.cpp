...
void Internal::PubRigidbodyPose(sRigidBodyData &data, Internal &internal)
{
    ...
    msgRigidBodyPose.header.frame_id = "map";
    ...
    msgTFRigidBodies.header.frame_id = "map";
...
{   
    ...
    {   internal.UnlabeledCount+=1;
        ...
        msgMarkerPose.header.frame_id = "map";
        ...
        msgTFMarker.header.frame_id = "map";
...
{
    internal.msgPointcloud.header.frame_id="map";
