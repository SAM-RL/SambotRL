...
from sambot_msgs.msg import bno055_info
...
def publisher():
	...
	dataPub = rospy.Publisher(ns+'imu/data', Imu, queue_size=3)
	infoPub = rospy.Publisher(ns+'imu/info', bno055_info, queue_size=3)
	headingPub = rospy.Publisher(ns+'imu/heading', Float64, queue_size=3)
	...
	while not rospy.is_shutdown():
		...
		msg.header.frame_id = ns[1:]+'imu_link'

		dataPub.publish(msg)

		info.header.stamp = rospy.Time.now()
		info.header.frame_id = ns[1:]+'imu_link'
