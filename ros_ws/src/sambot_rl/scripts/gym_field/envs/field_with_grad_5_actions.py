...
class SpatialTemporalFieldWithGradConcFiveActions(gym.Env):
    """
    ...
    def __init__(
        ...
        super(SpatialTemporalFieldWithGradConcFiveActions, self).__init__()
    ...
    def step(self, action_id):
        ...
        assert action in ["left", "right", "up",
                          "down", "stay"], "%s (%s) invalid" % (action, type(action))
