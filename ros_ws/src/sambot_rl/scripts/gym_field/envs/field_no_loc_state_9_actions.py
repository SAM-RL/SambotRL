...
class SpatialTemporalFieldNoLocStateWithGradRewardConcNineActions(gym.Env):
    ...
    def __init__(
        ...
        print(f"========> {self.env_curr_field.dtype}")
    ...
    def create_field(self):
        ...
        u_1 = u.copy()
        # source_1_c_shift = 13 #TODO Refactor 
        source_1_c_shift = 0
        ...
        reverse_u_1 = u.copy()
        # source_2_r_shift = 10 #TODO Refactor 
        # source_2_c_shift = 2
        source_2_r_shift = 0
        source_2_c_shift = 0
    ...
    def update_env_field(self):
        ...
        # fmt: on                                                                                                                                                                                          i])
        # idx = np.where(updated_u<0)
        # print(idx)
        # updated_u[idx]=0
        # idx = np.where(updated_u>20)
        # updated_u[idx]=20
    ...
    def step(self, action_id):
        ...
        if (hit_wall):
            ...
            return (reward, [concentration, self.agent_gradients[0], self.agent_gradients[1]], True, observation)
        ...
        return (reward, [concentration, self.agent_gradients[0], self.agent_gradients[1]], done, observations)
    ...
    def update_agent_field_and_coverage(self, next_state):
        ...
        field_params = {
            "dx": 0.8,
            "dy": 0.8,
            "vx": 0,  # 3: -0.7, 4: 0.7, 2: -0.6
            "vy": 0,    # 3: -0.3, 4: -0.4, 2: 0.8
            "dt": 0.1,
            "k": 0.1
        }
