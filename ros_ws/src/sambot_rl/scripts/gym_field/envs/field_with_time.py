...
class SpatialTemporalFieldWithTimeEnv(gym.Env):
    """
    This environment is similar to the regular field, except the state vector contains a third element
    of time.
    """
    def __init__(
                self,
        ...
        super(SpatialTemporalFieldWithTimeEnv, self).__init__()
        ...
        high = np.array([99.0, 99.0, self.max_num_steps - 1.0])
    ...
    def step(self, action_id):
        ...
        if (hit_wall):
            ...
            return (reward, [self.agent_position[0], self.agent_position[0], self.num_steps + 1], True, {})
        ...
        return (reward, [next_position[0], next_position[1], self.num_steps], done, observations)
    ...
    def reset(self):
        ...
        return [self.agent_position[0], self.agent_position[1], self.num_steps]
    ...
    def update_agent_field_and_coverage(self, next_state):
        ...
        self.agent_field_visited[vs_min_row:vs_max_row,vs_min_col:vs_max_col] = 1
