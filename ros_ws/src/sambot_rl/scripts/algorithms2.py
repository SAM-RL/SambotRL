...
class DestinationChooser:
    ...
    def find_destination(self, curr_location, visited, hop_over=10, boundary_limit=5):
        ...
        best_candidate, best_candidate_dict = self.get_best_candidate(
            curr_location, candidates, visited)
...
class Controller:
    ...
    def choose_action(self, curr_location):
        ...
        print(curr_location, next_location)
